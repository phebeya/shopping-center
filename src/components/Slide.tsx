...
const Slide:React.FC<propsType> = ({ img, title, mainTitle}) => {
  return (<div className="outline-none border-none relative">
    ...
    -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#be5e5ea2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
        <h3 className="text-pink-800 text-[50px] font-semibold lg:text-[40px] italic py-29 ">{title}</h3>
    ...
    <Image className=" w-[100%] h-[100px] md:h-auto rounded-xl 
     object-cover object-right md:object-left-bottom py-5"
     src={img}
     alt="banner"
     width={3000}
      height={3000}/>
